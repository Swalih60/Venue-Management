...
class ReusableMainScreen extends StatefulWidget {
  const ReusableMainScreen({
    ...
    required this.updationScreen,
  }) : super(key: key);

  final String databaseName;
  final Widget updationScreen;

  @override
  // ignore: library_private_types_in_public_api
  _ReusableMainScreenState createState() => _ReusableMainScreenState();
}
              ...
              IconButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => widget.updationScreen,
                  ));
                },
